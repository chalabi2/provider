...
type VolumeInformer interface {
	...
	Lister() akashnetworkv2beta2.VolumeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AkashV2beta2().Volumes(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AkashV2beta2().Volumes(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AkashV2beta2().Volumes(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AkashV2beta2().Volumes(namespace).Watch(ctx, options)
			},
		},
		&apisakashnetworkv2beta2.Volume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisakashnetworkv2beta2.Volume{}, f.defaultInformer)
}

func (f *volumeInformer) Lister() akashnetworkv2beta2.VolumeLister {
	return akashnetworkv2beta2.NewVolumeLister(f.Informer().GetIndexer())
}
