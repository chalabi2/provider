...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeGroupID) DeepCopyInto(out *VolumeGroupID) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeGroupID.
func (in *VolumeGroupID) DeepCopy() *VolumeGroupID {
	if in == nil {
		return nil
	}
	out := new(VolumeGroupID)
	in.DeepCopyInto(out)
	return out
}
